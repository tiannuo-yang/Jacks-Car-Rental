...
def plot_pi_a_s(iter_step):
    ...
    plt.savefig(f"./nopoisson_4.3_jack_rental_case_pi_a_s_iter{iter_step}.png",dpi=300,bbox_inches='tight',pad_inches=0)
    plt.close()
...
def plot_vpi_s():
    ...
    plt.savefig(f"./nopoisson_4.3_jack_rental_case_vpi_s.png",dpi=300,bbox_inches='tight',pad_inches=0)
    plt.close()
